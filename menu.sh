...
# ====== 配置部分 ======
CONFIG_URL="${CONFIG_URL:-https://raw.eaidan.com/cuteaidan/shell/refs/heads/main/scripts.conf}"
BACKUP_URL="https://raw.githubusercontent.com/cuteaidan/shell/refs/heads/main/scripts.conf"
PER_PAGE=10
BOX_WIDTH=41
LEFT_INDENT="        "
...
print_page() {
  ...
  # 条目保持原顺序
  [[ -n "${CHILDREN[$path]:-}" ]] && while IFS= read -r line || [ -n "$line" ]; do
